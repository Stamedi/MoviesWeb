...
$info = array_slice(scandir($info_dir), 2);
// var_dump($blogs);
// echo "<br>";
...
<?php if ($node) :
    ...
    if ($nodeId) :
      $nodeItems = file_get_contents($info_dir . '/kids' . $infoId[$nodeId] . '.txt');
  ...
  <div class="row mt-3">
    <div class="col-3 my-5 py-5">
      ...
      <a href="./?pg=kids" class="btn buttons my-5">Back to All Movies</a>
    </div>
  ...
  <div class="row my-5 mx-5">
    <div class="col">
      ...
      <a href="./?pg=kids" class="btn btn-outline-secondary">Back to All Movies</a>
  ...
  <div class="container kids-header text-center">
    ...
    <?php foreach ($info as $value) :
        $inf = file_get_contents($info_dir . '/' . $value);
      ...
      ?>
          ...
          <div class="col movie">
              ...
              <p class="text"><?php echo $in_text; ?></p>
                  <a href="./?pg=kids&node=<?php echo $nodeId; ?>" class="btn-b">More Info</a>
            </div>
    <?php endforeach; ?>
      </div>
      <?php endif; ?>
